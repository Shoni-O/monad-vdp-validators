...
export default function ScoreExplanation() {
  return (
    <section className="rounded-lg border-2 border-purple-200 bg-purple-50 p-5 text-sm">
      <h2 className="mb-3 font-semibold text-purple-900">About the score</h2>
      ...
      <p className="text-purple-800">
        ...
        <Link href="/methodology" className="font-medium text-purple-700 underline hover:text-purple-900">
          methodology
        </Link>
        .
      </p>
